var http = require('http'), //This module provides the HTTP server functionalities
    ...
    expAutoSan = require('express-autosanitizer'); //This modules does the autosanitizer for the application
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('HolidayPlanner.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('HolidayPlanner.xsl', 'utf8'); //We are reading in the XSL file
